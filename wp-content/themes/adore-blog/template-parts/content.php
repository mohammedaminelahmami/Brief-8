	...
	?>
		...
		<div class="entry-container">
	        ...
	        <div class="entry-content">
	            <?php
					$archive_content_type = get_theme_mod( 'adore_blog_enable_archive_content_type', 'excerpt' );
	    ...
	    <div class="entry-meta">
			<?php
				$archive_date_enable = get_theme_mod( 'adore_blog_enable_archive_date', true );
				$archive_category_enable = get_theme_mod( 'adore_blog_enable_archive_cat', true );
			?>
